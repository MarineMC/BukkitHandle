...
public class BukkitServer implements Server {
    ...
    private final BukkitPlayerHandler players;

    public BukkitServer(final BukkitHandle handle) {
        this.handle = handle;
        this.map = handle.config.map;
        this.players = new BukkitPlayerHandler();
    }
